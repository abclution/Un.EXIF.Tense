...
# exiftool argfile
###############################################################################
#! 	TITLE: TEMPLATE_S02-P01_MOVE-NON-EXIF-FILES.argfile.sh
...
###############################################################################
###############################################################################
# WORKFLOW 2 - STEP 1/1  - MOVE NON EXIF FILES OUT OF THE WAY
###############################################################################
###############################################################################
###############################################################################
...
$_DIRSTART_$_DSTDIR_/$_NOEXIFDEST_/$_YEAR_/$_YEARMONTH_$_MAKE_$_ANDROIDMANUFACTURER_$_MODEL_$_ANDROIDMODEL_$_XIAOMIPRODUCTNAME_
