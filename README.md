...
# Un.EXIF.Tense (OrganizeMyPhotos)
...
| `-T` | `Boolean` | Reset Test Mode data (clobbers IN/OUT folders). |
...
Update these variables within `fixd.OrganizeMyPHOTOS_v7.71.sh` before first use:
